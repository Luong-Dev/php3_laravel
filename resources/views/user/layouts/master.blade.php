...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/user/header-footer.css') }}">
    <link rel="stylesheet" href="{{ asset('css/user/home-page.css') }}">
    <link rel="stylesheet" href="{{ asset('css/user/breadcrumb.css') }}">
